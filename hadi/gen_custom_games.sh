...
do
  ...
  do
    ...
    do
      ...
      do
        sem -j 15 ./train $base_dir $goal $world_size $nb_objects $quest_length
        sem -j 3 ./valid $base_dir $goal $world_size $nb_objects $quest_length
        sem -j 3 ./test $base_dir $goal $world_size $nb_objects $quest_length
      done
    done
  done
done

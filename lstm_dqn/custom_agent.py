...
class CustomAgent:
    def __init__(self):
        ...
        """
        self.mode = "train"
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "vocab.txt")) as f:
            self.word_vocab = f.read().split("\n")
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "config.yaml")) as reader:
